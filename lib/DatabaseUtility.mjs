...
export default class DatabaseUtility {
    ...
    static async getUserFitbitDailyGoalAndWearingMinutesDuringPeriodById(fitbitId, startDateString, endDateString, goalType){
        ...
        for(let i = recordList.length - 1; i >= 0; i--){
            ...
            console.log(`${this.name} getUserFitbitDailyDateAndGoalDuringPeriodById record dateTime: ${record.dateTime}`);

            if(dateMins.dateTime != record.dateTime){
                console.log(`${this.name} getUserFitbitDailyDateAndGoalDuringPeriodById date mismatch: ${dateMins.dateTime} vs ${record.dateTime}`);
                break;
            }
            ...
            dateAndGoal =  {
                ...
                wearingMinutes: dateAndMinsList[i]
            };
