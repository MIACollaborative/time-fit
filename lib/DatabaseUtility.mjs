...
export default class DatabaseUtility {
    ...
    static async queryAndStoreFitbitActivitySummaryAtTargetDateForUser(userInfo, targetDate, insertToDB=true){
        ...
        console.log(`${this.name}.queryAndStoreFitbitActivitySummaryAtTargetDateForUser: query result: ${activityResult.value}`);
        ...
        if(insertToDB == true && activityResult.value == "success"){
            ...
            let dateTime =  targetDate.toISODate(); //resultData[dataType][0].startDate;
    ...
    static async queryAndStoreFitbitHeartRateAtTargetDateForUser(userInfo, targetDate, insertToDB=true){
        ...
        if(insertToDB == true && activityResult.value == "success"){
            ...
            let dateTime = targetDate.toISODate(); //resultData[dataType][0].dateTime;
            let compositeId = GeneralUtility.generateCompositeIDForFitbitUpdate([updatedUserInfo.fitbitId, dataType, dateTime]);
