...
export default class DatabaseUtility {
    ...
    static async getUserFitbitUpdateDuringPeriodByIdAndOwnerType(fitbitId, startDateTime, endDateTime, ownerType="user"){
    ...
    static async getUserFitbitHeartRateIntradayMinutesByIdAndDate(fitbitId, startDateTime){
        ...
        if(record != undefined){
            let heartRateZonesList = record["activities-heart"][0]["value"]["heartRateZones"];
    ...
    static async getFitbitUpdateByStatusWithLimit(status="notification", limit=50, prioritizeSystemUpdate=true){
        ...
        updateList = await prisma.fitbit_update.findMany({
            where:{
                status: status
            },
            take: limit,
