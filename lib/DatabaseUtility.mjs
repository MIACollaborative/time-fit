...
export default class DatabaseUtility {
    ...
    static async queryAndStoreFitbitIntradayDataAtTargetDateForUser(userInfo, fitbitIntradayDataType, targetDate, insertToDB=true, numOfDays=1){
        console.log(`${this.name}.queryAndStoreFitbitIntradayDataAtTargetDateForUser: ${userInfo.username}, ${fitbitIntradayDataType}, ${targetDate}, numOfDays: ${numOfDays}`);
    ...
    static async queryAndStoreFitbitIntradayDataByFitbitUpdate(fitbitUpdate, fitbitIntradayDataType, insertToDB=true){
        ...
        const summaryResult = await DatabaseUtility.queryAndStoreFitbitIntradayDataAtTargetDateForUser(userInfo, targetDate, insertToDB, 1);
