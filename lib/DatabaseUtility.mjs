        ...
        */
        ...
        for(let i = 0; i < matchList.length; i++){
            ...
            if(v.startsWith(match, 'response', 1)){
                ...
                // now, need to sort the responses by their createdAt
                responseList.sort((responseA, responseB) => {
                    return GeneralUtility.diffDateTime(DateTime.fromJSDate(responseA.createdAt), DateTime.fromJSDate(responseB.createdAt));
                });
