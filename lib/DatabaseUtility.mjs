...
export default class DatabaseUtility {
    ...
    static async queryAndStoreFitbitIntradayHeartRateAtTargetDateRangeForUser(userInfo, targetDateStart, targetDateEnd, insertToDB=true, numOfDays=1){
        console.log(`${this.name}.queryAndStoreFitbitIntradayHeartRateAtTargetDateRangeForUser: ${userInfo.username}, ${targetDateStart}, ${targetDateEnd}, numOfDays: ${numOfDays}`);
        ...
        */
        ...
        .then((responseData) => {
          console.log(
            `FitbitHelper.queryAndStoreFitbitIntradayHeartRateAtTargetDateRangeForUser: ${JSON.stringify(
              responseData
            )}`
          );
        ...
        console.log(`${this.name}.queryAndStoreFitbitIntradayHeartRateAtTargetDateRangeForUser [${targetDateStart.toFormat('yyyy-MM-dd')}][${targetDateEnd.toFormat('yyyy-MM-dd')}]: query result: ${activityResult.value}`);
