    ...
    static async getUserFitbitAverageDailyStepsDuringPeriodById(fitbitId, startDateString, endDateString){
        ...
        let stepsList = recordList.map((record) => {
            if(record.summary != undefined){
                return record.summary.steps;
            }
            else{

                console.log(`${this.name} getUserFitbitAverageDailyStepsDuringPeriodById recoord (no summary): ${JSON.stringify(record, null, 2)}`);
                return 0;
            }
