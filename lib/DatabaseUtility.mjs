        ...
        for(let i = 0; i < matchList.length; i++){
            ...
            if(v.startsWith(match, 'survey_link_from_tasks', 1)){
                ...
                taskLogWithSurveyLinkList.sort((itemA, itemB) => {
                    let diffInSeconds =  GeneralUtility.diffDateTime(DateTime.fromJSDate(itemA.dateTime), DateTime.fromJSDate(itemB.dateTime), "seconds").toObject().seconds;
                ...
                */
                ...
                result.message = voca.replaceAll(result.message, match, lastSurveyLink);
