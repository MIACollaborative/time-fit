...
export default class DatabaseUtility {
    ...
    static async getUserFitbitDailyDateAndGoalDuringPeriodById(fitbitId, startDateString, endDateString, goalType, recentLimit){
        ...
        let minsList = [];
        if(fitbitId != undefined && fitbitId.length > 0){
            minsList = await DatabaseUtility.getUserFitbitWearingMinutesPerDayListDuringPeriod(fitbitId, startDate, endDate);
        }
        ...
        for(let i = minsList.legnth - 1; i >= 0; i--){
            ...
            if (recentLimit !== undefined && goalList.length >= recentLimit) {
                break;
            }
        }
