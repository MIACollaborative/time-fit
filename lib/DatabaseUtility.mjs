...
export default class DatabaseUtility {
    ...
    static async shouldFitbitUpdateBeProcessed(fitbitUpdate){
        ...
        console.log(`${this.name}.shouldFitbitUpdateBeProcessed timezone: [${userInfo.timezone}]--------------`);
        ...
        console.log(`${this.name}.shouldFitbitUpdateBeProcessed targetDate: [${targetDate}]--------------`);
