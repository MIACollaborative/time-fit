...
*/
  ...
  static async getActivityGoalsForFitbitID(encodedId, accessToken, periodString="daily") {
    ...
    */
    ...
    return axios({
      method: "get",
      url: `https://api.fitbit.com/1/user/${encodedId}/activities/goals/${dperiodString}.json`,
      // `headers` are custom headers to be sent
      headers: {
        Authorization: `Bearer ${accessToken}`,
        Accept: `application/json`,
  ...
  static async setActivityGoalsForFitbitID(encodedId, accessToken, periodString="daily", category="steps", targetGoalValue=0) {
    ...
    */
    ...
    return axios({
      method: "post",
      url: `https://api.fitbit.com/1/user/${encodedId}/activities/goals/${dperiodString}.json?${category}=${targetGoalValue}`,
      // `headers` are custom headers to be sent
      headers: {
        Authorization: `Bearer ${accessToken}`,
        Accept: `application/json`,
