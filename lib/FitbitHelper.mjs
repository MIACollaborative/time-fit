...
*/
  ...
  static async getActvitySummaryAtDateForFitbitId(encodedId, accessToken, dateTime) {
    console.log(
      `${this.name}.getActvitySummaryAtDateForFitbitId: fitbitId: ${encodedId}, accessToken: ${accessToken}`
    );
    return axios({
      method: "get",
  ...
  static async getHeartRateAtDateForFitbitId(encodedId, accessToken, dateTime, period="1d") {
    console.log(
      `${this.name}.getHeartRateAtDateForFitbitId: fitbitId: ${encodedId}, accessToken: ${accessToken}`
    );
    return axios({
      method: "get",
