...
*/
  ...
  static async getIntradayHeartRateBetweenDateRangeForFitbitId(encodedId, accessToken, dateTimeStart, dateTimeEnd, detailLevel="1min") {
    console.log(
      `${this.name}.getIntradayHeartRateBetweenDateRangeForFitbitId: fitbitId: ${encodedId}, accessToken: ${accessToken}, dateTimeStart: ${dateTimeStart.toISODate()}, dateTimeEnd: ${dateTimeEnd.toISODate()}`
    );
    ...
    return axios({
      method: "get",
      url: `https://api.fitbit.com/1/user/${encodedId}/activities/heart/date/${dateTimeStart.toISODate()}/${dateTimeEnd.toISODate()}/${detailLevel}.json`,
      // `headers` are custom headers to be sent
      headers: {
        Authorization: `Bearer ${accessToken}`,
        Accept: `application/json`,
