...
-d "token=<The OAuth 2.0 token to retrieve the state>"
  ...
  static async createSubscriptionForFitbitId(fitbitId, collectionPath, subscriptionId, accessToken) {
    console.log(`${this.name}.createSubscriptionForFitbitId: fitbitId: ${fitbitId}, collectionPath: ${collectionPath}, subscriptionId: ${subscriptionId}, accessToken: ${accessToken}`);
