...
export default class GeneralUtility {
        ...
        },
        {
            ...
            checkPoint: {
                ...
                reference: {
                    ...
                    type: "fixed",
                    value: "08:00 PM" // "00:01 AM" // (if preference) (wakeupTime, bedTime, createdAt) -> need to support wakeupTime
                        ...
                        criteria: {
                            period: {
                                ...
                                // DEACTIVATE AFTER TESTING
                                    ...
                                    reference: "ActivateAtDate",
                                    offset: { type: "plus", value: { days: 300 } }
                                }
            ...
            preCondition: {
                ...
                conditionList: [
                    ...
                    },
                    {
                        ...
                        opposite: false, // message sent = True
                        criteria: {
                            messageLabel: "prompt-re_7, prompt-re_8",
                            period: {
                                // Start: the starting piont of the time window to consider
                                // Removing it means we are consider a time window starting from the very beginning of time (year 200 for impelementation)
                                // reference:
                    ...
                    },
                    {
                        ...
                        criteria: {
                            ...
                            period: {
                                ...
                                start: {
                                    reference: "today",
                                    offset: { type: "minus", value: { days: 14 } } // checks for survey completion the last 5 days (not including the day of message)
                                },
    ...
    static generateDateTimeByReference(targetDateTime, userInfo, reference, startEndOfUnit="no", startEndUnit="day") {
        console.log(`${this.name} generateDateTimeByReference: ${targetDateTime}, ${reference}`);
        let resultDateTime;
    ...
    static extractOutcomeToString(theChoice) {
        let result = `[${theChoice.chance}]${theChoice.action.type} -`;
