        ...
        },
        {
            ...
            checkPoint: {
                ...
                reference: {
                    ...
                    value: "08:00 AM" // (if preference) (wakeupTime, bedTime, createdAt) -> need to support wakeupTime
        ...
        },
        {
            ...
            checkPoint: {
                ...
                reference: {
                    ...
                    // fixed
                    type: "fixed", // fixed or preference
                    value: "04:00 PM" // (if preference) (wakeupTime, bedTime, createdAt) -> need to support wakeupTime
