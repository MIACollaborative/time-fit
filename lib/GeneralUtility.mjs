    ...
    static taskList = [
        {
            ...
            checkPoint: {
                ...
                // If a task should be executed at the specified time, then simply removing this section.
                /*
                repeat: {
            ...
            randomization:{
                ...
                // Randomization outcome: defines the chance (or probability) that an outcome should be chosen and carried out.
