...
export default class GeneralUtility {
    ...
    static taskList = [
        {
            label: "participant activation",// we need to manually make sure that it is unique
            enabled: true,
                ...
                outcome: [
                    {
                        ...
                        action: {
                            ...
                            // messageLabel, messageGroup, retrieveFitbitData, processFitbitUpdate, activateParticipant
        ...
        },
        {
            ...
            checkPoint: {
                ...
                reference: {
                    ...
                    // fixed
                    type: "fixed", // fixed or preference
                    value: "7:00 PM" // (if preference) (wakeupTime, bedTime, createdAt) -> need to support wakeupTime
