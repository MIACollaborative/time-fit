                    ...
                    },
                    {
                        ...
                        criteria: {
                            ...
                            period: {
                                ...
                                start:{
                                    reference: "today",
                                    offset: {type: "minus", value: {days: 3}} // checks for wearing adherence the last 3 days
                                },
                                // reference:
                                // now: current time
                                // today: start of today (00:00:00 am)
            ...
            preCondition: {
                ...
                conditionList: [
                    ...
                    // Participants can be on either baseline or intervention to receive fitbit wearing reminders
                    {
                        ...
                        type: "hasHeartRateIntradayMinutesAboveThresholdForPersonByDate", // This type can only check the specified date inside the start: {}
                        opposite: false, // participant has been wearing
                        criteria: {
                            // Id list: list of Qualtrics survey Ids to check
                            idList: [""],
                            ...
                            // check whether minutes >= wearingLowerBoundMinutes
                            wearingLowerBoundMinutes: 30 * 1, // Day of checking for adherence (wakeup+1hr) will always return adherent, thus won't be counted towards Fitbit non-worn day.
                            ...
                            period: { 
                                ...
                                start:{
                                    reference: "today",
                                    offset: {type: "plus", value: {days: 0}} // check today since 00:00:00 am
                                },
                                // End doesn't matter for Fitbit wearing
                                // Removing it means we are consider a time window up to this point
                                // end:{
                    ...
                    {
                        // Check if participant's Fitbit has detected activity 5 days ago - must return True for reminder to stop at day 5.
                        type: "hasHeartRateIntradayMinutesAboveThresholdForPersonByDate",
                        opposite: true,
                        criteria: {
                            // Id list: list of Qualtrics survey Ids to check
                            ...
                            period: {
                                ...
                                start:{
                                    reference: "today",
                                    offset: {type: "minus", value: {days: 5}} // if survey was NOT completed the last 5 days.
                                },
                                // End doesn't matter for Fitbit wearing
                                // Removing it means we are consider a time window up to this point
                                // end:{
