const taskList = [
    ...
    {
        label: "goal_setting_morning",// we need to manually make sure that it is unique
        enabled: true,
            ...
            outcome: [
                {
                    ...
                    action: {
                        ...
                        messageLabel: "", //messageLabel, only matter if the type is messageLabel
                        messageGroup: "goal-m", // "nongif-m", // messageGroup, only matter if the type is messageGroup
