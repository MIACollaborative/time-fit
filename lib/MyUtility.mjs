    ...
    static taskList = [
        {
            ...
            group: {
                ...
                list:["test1"] // user name list, only matter if type is "list"
            },
            randomization:{
                ...
                outcome: [
                    {
                        ...
                        action: {
                            ...
                            messageLabel: "test_1", //messageLabel, only matter if the type is messageLabel
        ...
        {
            label: "Testing scenario_2",// we need to manually make sure that it is unique
            index: 2, // we need to programmatically make sure that this is unique
            checkPoint: {
        ...
        {
            label: "Testing scenario_3",// we need to manually make sure that it is unique
            index: 3, // we need to programmatically make sure that this is unique
            checkPoint: {
                type: "absolute", // absolute vs. relative, ignore
                reference: {
                    weekIndexList:[1,2,3,4,5,6,7],
        ...
        {
            label: "Testing scenario_4",// we need to manually make sure that it is unique
            index: 4, // we need to programmatically make sure that this is unique
            checkPoint: {
                type: "relative", // absolute vs. relative, ignore
                reference: {
                    weekIndexList:[1,2,3,4,5,6,7],
        ...
        {
            label: "Testing scenario_5",// we need to manually make sure that it is unique
            index: 5, // we need to programmatically make sure that this is unique
            checkPoint: {
                type: "absolute", // absolute vs. relative, ignore
                reference: {
                    weekIndexList:[1,2,3,4,5,6,7],
