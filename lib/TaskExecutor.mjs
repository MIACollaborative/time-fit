    ...
    static async checkOneConditionForUser(condition, userInfo, dateTime) {
        ...
        switch (condition.type) {
            ...
            case "hasHeartRateIntradayMinutesAboveThresholdForPersonByDateRange":
                ...
                console.log(`${this.name} checkOneConditionForUser type: ${condition.type}: start: ${startDate},  end: ${endDate}, wearingLowerBoundMinutes: ${wearingLowerBoundMinutes}, idRelationship: ${idRelationship}`);
