        ...
        switch (condition.type) {
            ...
            case "surveyFilledByThisPerson":
                ...
                */
                ...
                console.log(`${this.name} checkOneConditionForUser[${this.taskSpec.label}] startDate: ${startDate}`);
                ...
                console.log(`${this.name} checkOneConditionForUser[${this.taskSpec.label}] endDate: ${endDate}`);
            ...
            case "timeInPeriod":
                ...
                */
                ...
                console.log(`${this.name} checkOneConditionForUser[${this.taskSpec.label}] condition: ${JSON.stringify(condition, null, 2)}`);

                console.log(`${this.name} checkOneConditionForUser[${this.taskSpec.label}] condition.criteria.start.reference: ${condition.criteria.start.reference}`);

                console.log(`${this.name} checkOneConditionForUser[${this.taskSpec.label}] userInfo: ${JSON.stringify(userInfo)}`);

                console.log(`${this.name} checkOneConditionForUser[${this.taskSpec.label}] userInfo.joinAt: ${userInfo.joinAt}`);
                console.log(`${this.name} checkOneConditionForUser[${this.taskSpec.label}] userInfo.timezone: ${userInfo.timezone}`);
                ...
                if (condition.criteria.start != undefined) {
                    switch (condition.criteria.start.reference) {
                        ...
                        case "activateAtDate":
                            ...
                            startDate = GeneralUtility.getLocalTime(DateTime.fromISO(userInfo.activateAt), userInfo.timezone).startOf("day").toUTC();
                            break;
                        case "joinAtDate":
                            // GeneralUtility.getLocalTime(DateTime.fromISO(userInfo.activateAt), userInfo.timezone).startOf("day").toUTC();
                            ...
                            startDate = GeneralUtility.getLocalTime(DateTime.fromISO(userInfo.joinAt), userInfo.timezone).startOf("day").toUTC();
                ...
                if (condition.criteria.end != undefined) {
                    switch (condition.criteria.end.reference) {
                        ...
                        case "activateAtDate":
                            // GeneralUtility.getLocalTime(DateTime.fromISO(userInfo.activateAt), userInfo.timezone).startOf("day").toUTC();
                            endDate = GeneralUtility.getLocalTime(DateTime.fromISO(userInfo.activateAt), userInfo.timezone).endOf("day").toUTC();
                            break;
                        case "joinAtDate":
                            // GeneralUtility.getLocalTime(DateTime.fromISO(userInfo.activateAt), userInfo.timezone).startOf("day").toUTC();
                            endDate = GeneralUtility.getLocalTime(DateTime.fromISO(userInfo.joinAt), userInfo.timezone).endOf("day").toUTC();
                            break;
                        default:
                            break;
                    }
