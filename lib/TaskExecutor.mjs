    ...
    static async checkOneConditionForUser(condition, userInfo, dateTime) {
        ...
        switch (condition.type) {
            ...
            case "messageSentDuringPeriod":
                ...
                console.log(`messageSentDuringPeriod taskLogList: ${taskLogList}`);
                ...
                console.log(`messageSentDuringPeriod (${condition.messageLabel}) for [${taskLogInfo.username == userInfo.username}] taskLogList.length > 0: ${taskLogList.length > 0}`);
