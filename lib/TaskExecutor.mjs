    ...
    static async executeActionForUser(theAction, userInfo, datetime) {
        ...
        switch (theAction.type) {
            ...
            case "activateParticipant":
                let result = DatabaseUtility.updateUserInfo(userInfo, {phase: "intervention"});
        ...
        switch(condition.type){
            ...
            case "surveyFilledByThisPerson":
                ...
                for(let i = 0; i < condition.criteria.idList.length; i++){
                   ...
                   let responseList = await DatabaseUtility.findSurveyResponoseDuringPeriod(surveyId, startDate, endDate);
