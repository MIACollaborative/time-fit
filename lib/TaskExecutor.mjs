...
export default class TaskExecutor {
    ...
    static async executeTaskForUserListForDatetime(taskSpec, userList, datetime) {
        ...
        userList = userList.filter((userInfo) => {
            ...
            // verion 1
            //let isGroupResult = TaskExecutor.isGroupForUser(taskSpec.group, userInfo);

            // a user does not pass group checking
            if(!isGroupResult){
                let taskLogObj = {};
        ...
        userList = userList.filter((userInfo) => {
            ...
            // version 1
            //let isCheckPointResult = TaskExecutor.isCheckPointForUser(taskSpec.checkPoint, userInfo, datetime);

            // a user does not pass check point
