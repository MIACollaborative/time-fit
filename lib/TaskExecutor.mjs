                ...
                */
                ...
                if (condition.criteria.start != undefined) {
                    switch (condition.criteria.start.reference) {
                        ...
                        case "joinAtDate":
                            // GeneralUtility.getLocalTime(DateTime.fromJSDate(userInfo.activateAt), userInfo.timezone).startOf("day").toUTC();
                            console.log(`startDate-DateTime.fromJSDate(userInfo.joinAt): ${DateTime.fromJSDate(userInfo.joinAt)}`);
                            console.log(`startDate-GeneralUtility.getLocalTime(DateTime.fromJSDate(userInfo.joinAt), userInfo.timezone): ${GeneralUtility.getLocalTime(DateTime.fromJSDate(userInfo.joinAt), userInfo.timezone)}`);
