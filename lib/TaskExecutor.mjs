...
export default class TaskExecutor {
    ...
    static async checkOneConditionForUser(condition, userInfo, dateTime) {
        ...
        switch (condition.type) {
            ...
            case "hasHeartRateIntradayForPersonByDate":
                startDate = undefined;
                endDate = undefined;

                let wearingLowerBoundMinutes = condition.criteria.wearingLowerBoundMinutes;
                ...
                */
                ...
                let minutes = await DatabaseUtility.getUserFitbitHeartRateIntradayMinutesByIdAndDate(userInfo.fitbitId, startDate);

                console.log(`${this.name} checkOneConditionForUser type: ${condition.type}: start: ${startDate},  minutes: ${JSON.stringify(minutes, null, 2)}`);

                result = minutes >= wearingLowerBoundMinutes;
                break;
