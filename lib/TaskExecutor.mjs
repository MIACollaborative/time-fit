  ...
  static async executeActionForUser(theAction, userInfo, datetime) {
    ...
    switch (theAction.type) {
      ...
      case "setPersonalizedDailyStepsGoal":
        ...
        const wearingDateGoalList =
          await DatabaseUtility.getUserFitbitDailyGoalsForWearingDaysDuringPeriodById(
            userInfo.fitbitId,
            startDateString,
            endDateString,
            "steps",
        ...
        if (wearingDateGoalList.length > 0) {
          ...
          averageStepGoal =
            wearingDateGoalList.reduce((total, next) => total + next.goal, 0) /
            wearingDateGoalList.length;
        } else {
        ...
        let updateResult = await DatabaseUtility.updateUserInfo(userInfo, {
          personalizedDailyStepsGoal: roundedStepGoal,
        });
        ...
        resultBody = {
          ...
          wearingDateGoalList: wearingDateGoalList,
        };
