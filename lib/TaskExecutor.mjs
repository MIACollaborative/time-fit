    ...
    static async isPreConditionMetForUser(conditionSpec, userInfo, dateTime) {
        ...
        */
        ...
        for (let i = 0; i < conditionSpec.conditionList.length; i++) {
            ...
            conditionEvaluationRecordList.push(checkResult, condition, recordInfo);
        }
        ...
        console.log(`${this.name} isPreConditionMetForUser[${userInfo.username}]: resultList: ${conditionEvaluationResultList}, result: ${result}`);
        ...
        switch (condition.type) {
            ...
            case "surveyFilledByThisPerson":
                ...
                */
                ...
                recordInfo.surveyFillResultList = surveyFillResultList;
            ...
            case "messageSentDuringPeriod":
                ...
                recordInfo.taskLogListLength = surveyFitaskLogList.length;
            ...
            case "hasFitbitUpdateForPersonByDateRange":
                ...
                */
                ...
                recordInfo.updateListLength = updateList.length;
